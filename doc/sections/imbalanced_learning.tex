...
As we detailed in \ref{sec:anomaly_detection}, records that received awards and nominations were often deemed anomalous.
...
We trained a One Class SVM with RBF kernel without hyperparameter tuning on records that didn't receive any awards in order to learn a discriminative boundary around normal instances.
Table \ref{tab:imb_learn_cv_performance} show results obtained by this method on 5-fold cross validation.
